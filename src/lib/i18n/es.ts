...
export const es: Strings = {
  ...
  "schedule.caveat":
    "Despierta un Mac dormido y abre la app a la hora de cada día, solo si has iniciado sesión (una pantalla bloqueada cuenta, cerrar sesión de verdad no): funciona con batería, pero un Mac completamente apagado permanece apagado, y con la tapa cerrada la app necesita una pantalla externa para abrirse de verdad. Las activaciones se programan con unas semanas de antelación, así que abre Agent Profiles de vez en cuando para mantenerlas.",
