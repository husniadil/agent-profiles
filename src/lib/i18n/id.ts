...
export const id: Strings = {
  ...
  "schedule.caveat":
    "Membangunkan Mac yang tidur dan membuka aplikasi pada waktu setiap hari, hanya jika Anda masih masuk — layar terkunci masih terhitung, hanya benar-benar keluar (logout) yang tidak — Mac bisa bekerja dengan baterai, tetapi Mac yang benar-benar dimatikan akan tetap mati, dan jika layar tertutup, aplikasi memerlukan monitor eksternal agar benar-benar terbuka. Bangun dijadwalkan beberapa minggu ke depan, jadi buka Agent Profiles sesekali agar tetap berjalan.",
