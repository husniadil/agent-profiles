...
export const ja: Strings = {
  ...
  "schedule.caveat":
    "各曜日の時刻に、スリープ中の Mac を復帰させ、ログイン中の場合のみアプリを起動します。約1分前に復帰し、バッテリーでも動作しますが、完全にシャットダウンしている Mac はそのまま起動しません。またふたを閉じている場合、外部ディスプレイがないとアプリは実際には開きません。復帰は数週間先まで予約されるため、継続させるには時々 Agent Profiles を開いてください。",
